...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-slate-50 flex flex-col items-center justify-center px-4">
      {/* Logo */}
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 p-7 slide-up">
        <div className="mb-6 text-center">
          <h1 className="text-xl font-bold text-slate-900">Xush kelibsiz!</h1>
          <p className="text-sm text-slate-500 mt-1">Davom etish uchun kirish kerak</p>
        </div>
